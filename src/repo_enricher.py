...
class RepoEnricher:
    ...
    def enrich_repository(self, repo:  Dict[str, Any]) -> Dict[str, Any]:
        ...
        enriched = {
            ...
            # Initialize all fields with defaults to prevent KeyError
            "created_at": None,
            "updated_at": None,
            "pushed_at":  None,
            ...
            "readme_length": 0,
            "ai_keyword_count": 0,
            "test_keyword_count": 0,
            "intersection_phrase_count": 0,
            "has_contributing": False,
            "has_code_of_conduct": False,
            "has_test_directory": False,
            "has_ci_config":  False,
            "ai_dependency_count": 0,
        }
        ...
        try:
            ...
            if repo_details:
                ...
                enriched["license"] = repo_details.get("license", {}).get("name") if repo_details.get("license") else None
                ...
                print(f"⚠️ Could not fetch repo details for {repo['full_name']}, using defaults")
        ...
        try:
            ...
            contributors = self._api_get(contributors_url, params={"per_page": 1, "anon": "true"})
            if contributors:
                # Similar to commits, this is an estimate
                enriched["contributor_count"] = len(contributors) if len(contributors) < 100 else 100
        except Exception as e:
        ...
        try:
            ...
            print(f"⚠️ Error counting AI dependencies for {repo['full_name']}: {e}")
    ...
    def _days_since(self, date_string: Optional[str]) -> Optional[int]:
